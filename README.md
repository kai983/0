...
**자동 (권장)**: 설정(팔레트 버튼)에 Gemini 무료 API 키를 한 번 넣어두면,
공유로 들어온 콘텐츠가 클릭 없이 요약-태그까지 자동으로 저장됩니다.
키는 aistudio.google.com/apikey 에서 무료로 만들 수 있고(하루 250회 무료),
기기에만 저장됩니다. 유튜브 링크는 Gemini가 영상을 직접 읽습니다.
